...
public class IUGrafica{
    ...
    static List<ElementoIU> elementos = new ArrayList<ElementoIU>();
    static Scanner sc = new Scanner(System.in);
    
    public static int menu() {
        
        FactoriaIU factoria =new FactoriaIU();
        elementos.add(factoria.hacerVentana());
        elementos.add(factoria.hacerDesplegable());
        elementos.add(factoria.hacerBoton());
        int opcion;
        System.out.println();
        System.out.println("-----------------------------------------");
