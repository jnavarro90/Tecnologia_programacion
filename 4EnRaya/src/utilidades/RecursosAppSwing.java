...
public class RecursosAppSwing {
  ...
  public static final String FICH_ICONO = "icono";
  ...
  private ImageIcon iconoGeneral;
  ...
  */    
  private void cargaGenerales() {
    ...
    iconoGeneral = new ImageIcon(this.getClass().getResource(
      RecursosAppSwing.RUTA_RECURSOS + 
      recursos.getValorEtiqueta(FICH_ICONO))); 
  }
